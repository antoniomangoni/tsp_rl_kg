...
class GraphProcessor(nn.Module):
    def __init__(self, num_graph_node_features, output_dim=128):
        super(GraphProcessor, self).__init__()
        self.output_dim = output_dim
        self.gat1 = GATConv(num_graph_node_features, 64, heads=4)
...
class AgentModel(BaseFeaturesExtractor):
    def __init__(self, observation_space: gym.spaces.Dict, features_dim: int = 256):
        ...
        self.vision_processor = VisionProcessor(vision_shape, features_dim=256)
        self.graph_processor = GraphProcessor(num_node_features, output_dim=256)
